...
// The model call can hang or be slow. We never let it hang the request
// indefinitely -- abort after REQUEST_TIMEOUT_MS and tell the client.
...
app.post("/api/plan", async (req, res) => {
  ...
  try {
    ...
    // One repair attempt: if JSON was malformed or didn't match the schema,
    // ask the model to fix it once before giving up.
    ...
    // Assign stable ids server-side so the client can key/reorder/remove
    // stops reliably -- the model is never asked to invent ids.
